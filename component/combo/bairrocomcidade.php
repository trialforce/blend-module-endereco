...
class BairroComCidade extends \Component\Combo
{
    ...
    public function getDataSource()
    {
        ...
        $columns[] = new \Component\Grid\Column('idCidade', 'Cidade', \Component\Grid\Column::ALIGN_LEFT, \Db\Column::TYPE_VARCHAR);
